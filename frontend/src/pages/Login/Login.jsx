      ...
      <main className="relative z-10 flex items-center justify-center min-h-screen px-margin-mobile md:px-0">
        ...
        <section className="glass-modal w-full max-w-[480px] rounded-xl p-xl shadow-[0px_4px_20px_rgba(0,0,0,0.1)] flex flex-col gap-lg">
          ...
          <nav className="flex p-xs bg-surface-container-low rounded-xl w-full">
              ...
              <span
                ...
                style={{
                  fontVariationSettings:
                    role === "Student" ? "'FILL' 1" : "'FILL' 0",
                }}
              >
                person
              </span>
              <span
                className={`font-label-sm text-label-sm ${role === "Student" ? "font-bold" : ""}`}
              >
                Student
              </span>
            </button>
            ...
            >
              <span
                ...
                style={{
                  fontVariationSettings:
                    role === "Parent" ? "'FILL' 1" : "'FILL' 0",
                }}
              >
                group
              </span>
              <span
                className={`font-label-sm text-label-sm ${role === "Parent" ? "font-bold" : ""}`}
              >
                Parent
              </span>
            </button>
            ...
            >
              <span
                ...
                style={{
                  fontVariationSettings:
                    role === "Staff / Admin" ? "'FILL' 1" : "'FILL' 0",
                }}
              >
                shield
              </span>
              <span
                className={`font-label-sm text-label-sm ${role === "Staff / Admin" ? "font-bold" : ""}`}
              >
                Staff / Admin
              </span>
            </button>
          ...
          <form className="flex flex-col gap-md" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="w-full h-[48px] bg-secondary-container text-on-primary font-title-md text-title-md rounded-xl shadow-lg hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-sm"
            >
              Login
      ...
      <footer className="w-full absolute bottom-0 flex flex-col md:flex-row justify-center items-center gap-md pb-sm font-label-sm text-label-sm text-white/70">
        <div className="px-margin-desktop flex flex-col md:flex-row justify-between items-center w-full max-w-7xl">
          ...
          <div className="flex gap-lg mt-sm md:mt-0">
            <a className="hover:text-white transition-opacity" href="#">
              Privacy Policy
            </a>
            <a className="hover:text-white transition-opacity" href="#">
              Terms of Service
